...
declare module "level" {
  ...
  var level: LevelConstructor;

  interface LevelConstructor {
    (location: string, options?: levelup.levelupOptions): levelup.LevelUp;
    (
      location: string,
      callback: (err: string, db: levelup.LevelUp) => any
    ): void;
    (
      location: string,
      options: levelup.levelupOptions,
      callback: (err: string, db: levelup.LevelUp) => any
    ): void;
  }
}
